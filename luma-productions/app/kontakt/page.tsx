...
export default function Kontakt() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative h-[300px] bg-gradient-to-r from-gray-900 to-gray-700 text-white flex items-center">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <h1 className="text-5xl md:text-6xl font-bold mb-4">
            Kontakt
          </h1>
          <p className="text-xl md:text-2xl text-gray-200">
            Javite nam se i razgovarajmo o vašem projektu
          </p>
        </div>
      </section>
          ...
          <div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-600 ml-9">info@fotostudio.hr</p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 ml-9">+385 XX XXX XXXX</p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 ml-9">Zagreb, Hrvatska</p>
              </div>
              ...
              <div>
                ...
                <p className="text-gray-600 ml-9">Pon - Pet: 9:00 - 18:00</p>
                <p className="text-gray-600 ml-9">Sub: 10:00 - 14:00</p>
                <p className="text-gray-600 ml-9">Ned: Po dogovoru</p>
              </div>
            </div>

            <div className="mt-8 p-6 bg-gray-50 rounded-lg">
              <h3 className="text-xl font-semibold mb-4">Brzi odgovor</h3>
              <p className="text-gray-700 mb-4">
                Obično odgovaramo unutar 24 sata. Za hitne upite, molimo pozovite nas direktno.
              </p>
